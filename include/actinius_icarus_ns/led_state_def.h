...
static const struct led_effect asset_tracker_led_effect[] = {
	...
	[LED_STATE_CLOUD_ASSOCIATING]	= LED_EFFECT_LED_CLOCK(LED_TICKS_DOUBLE,
							       LED_COLOR(255/16, 255/16, 255/16)),
	[LED_STATE_CLOUD_ASSOCIATED]	= LED_EFFECT_LED_ON_GO_OFF(LED_COLOR(255/16, 255/16, 255/16),
								   LED_PERIOD_NORMAL,
								   LED_PERIOD_RAPID),
	[LED_STATE_ACTIVE_MODE]		= LED_EFFECT_LED_BREATH(LED_PERIOD_NORMAL,
								LED_COLOR(0, 255/16, 255/16)),
	[LED_STATE_PASSIVE_MODE]	= LED_EFFECT_LED_BREATH(LED_PERIOD_NORMAL,
								LED_COLOR(0, 0, 255/16)),
	[LED_STATE_ERROR_SYSTEM_FAULT]	= LED_EFFECT_LED_ON(LED_COLOR(255/16, 0, 0)),
	[LED_STATE_FOTA_UPDATING]	= LED_EFFECT_LED_BREATH(LED_PERIOD_RAPID,
								LED_COLOR(255/16, 165/16, 0)),
	[LED_STATE_FOTA_UPDATE_REBOOT]	= LED_EFFECT_LED_ON(LED_COLOR(255/16, 165/16, 0)),
